...
const FindMe = () => {
  return (
    ...
    <section
      className="min-h-screen bg-transparent flex items-center justify-center px-8 py-24 relative overflow-hidden"
    >
  ...
  <p className="text-gray-450 text-[9px] xs:text-[11px] sm:text-sm text-center">
    Connect with me professionally.
          ...
          <motion.a
            ...
            href="https://www.instagram.com/adii.sharma2555?igsh=MTd0bGZ2Y2hmd2hmcQ=="
